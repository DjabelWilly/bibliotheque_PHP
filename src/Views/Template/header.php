        ...
        <div class="container-fluid align-items-center">
            ...
            <ul class="d-flex align-items-center gap-2 list-unstyled">
                <li class="d-flex align-items-center">
                    <a class="d-flex text-decoration-none my-3 me-3" role="search" href="?controller=HomeController&method=home"><svg
                ...
                <li>
                    <a class="d-flex text-decoration-none me-3" role="search" href="?controller=SearchController&method=index"><svg
                            xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor"
                ...
                <li>
                    <a class="d-flex text-decoration-none my-3 me-3" role="search"
                        href="?controller=GenreController&method=displayGenre">Genre</a>
                </li>
            </ul>
        </div>
    </nav>
